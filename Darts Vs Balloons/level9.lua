...
function new()
	...
	local enemyDensity = 0
	local enemyShape = { -12,-13, 12,-13, 12,28, -12,28}
	--local dartShape = { -70,-10, 72,-10, 72,10, -70,10}
	...
	local startNewRound = function()
		if characterObject then
			...
			if gameGroup.x < 0 then
				transition.to( gameGroup, { time=2000, x=0, transition=easing.inOutExpo, onComplete=activateRound } )
			else
				gameGroup.x = 0
				activateRound()
			end
	...
	local callGameOver = function( isWin )
		...
		if isWin == "yes" then
			...
			local characterBonus = gameLives * 10000
	...
	local drawBackground = function()
		...
		-- BACKDROP
		backgroundImage1 = display.newImageRect( backgroundFilename1, 650, 320 )
		backgroundImage1:setReferencePoint( display.CenterLeftReferencePoint )
		backgroundImage1.x = -50; backgroundImage1.y = 120
		
		backgroundImage2 = display.newImageRect( backgroundFilename2, 600, 320 )
		backgroundImage2:setReferencePoint( display.CenterLeftReferencePoint )
		backgroundImage2.x = 600; backgroundImage2.y = 120
	...
	local drawHUD = function()
		...
		-- LIVES DISPLAY
		life1 = display.newImageRect( "lifeicon.png", 15, 39 )
		life1.x = 20; life1.y = 24
		
		life2 = display.newImageRect( "lifeicon.png", 15, 39 )
		life2.x = life1.x + 25; life2.y = 24
		
		life3 = display.newImageRect( "lifeicon.png", 15, 39 )
		life3.x = life2.x + 25; life3.y = 24
		
		life4 = display.newImageRect( "lifeicon.png", 15, 39 )
		life4.x = life3.x + 25; life4.y = 24
		...
		continueText = display.newText( "TAP TO CONTINUE", 240, 18, "Helvetica", 38 )
		continueText:setTextColor( 0, 0, 0)
			...
			if event.phase == "release" and pauseBtn.isActive then
				...
				if gameIsActive then
					...
					if not shadeRect then
						shadeRect = display.newRect( -50, 0, 600, 320 )
						shadeRect:setFillColor( 0, 0, 0, 255 )
						hudGroup:insert( shadeRect )
					end
					shadeRect.alpha = 0.5
		...
		local onMenuPauseTouch = function( event )
			if event.phase == "release" and pauseMenuBtn.isActive then
				...
				local alert = native.showAlert( "Quit Game?", "Do you want to go back to the MainMenu?", 
		...
		pauseMenuBtn.x = 0; pauseMenuBtn.y = 295
		pauseMenuBtn.isVisible = false
		pauseMenuBtn.isActive = false
	...
	local createGround = function()
		...
		groundObject1 = display.newImageRect( "ground1.png", 530, 76 )
		groundObject1:setReferencePoint( display.BottomLeftReferencePoint )
		groundObject1.x = -50; groundObject1.y = 320
		
		groundObject2 = display.newImageRect( "ground2.png", 600, 76 )
		...
		local groundShape = { -1000,-1, 300,-1, 300,18, -300,18 }
	...
	local createCharacter = function()
		...
		characterObject = movieclip.newAnim({ "Dart1.png", "Dart2.png" },25, 65)
		characterObject.x = 150; characterObject.y = 1150
		characterObject.isVisible = true
		characterObject.radius = 10
		...
		physics.addBody( characterObject, "static", { density=1.0, bounce=0.0, friction=0.15, radius=characterObject.radius } )
		characterObject.rotation = 0
		characterObject:stopAtFrame( 1 )
	...
	local onEnemyPostCollision = function( self, event )
		if event.force > -100 and self.isHit == false then
			...
			poofTween = transition.to( greenPoof, { time=3000, alpha=1.0, onComplete=fadePoof } )
	...
	local createLevel = function()
		...
		-- Rabbits
		local enemy1 = display.newImageRect( "SapphireBlue.png", 30, 45 )
		--enemy1.radius = 10
		...
		physics.addBody( enemy1, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy1 )
		enemy1.gravityScale = 0
		--enemy1:setLinearVelocity( 0, -1 )

		enemy1.postCollision = onEnemyPostCollision
		enemy1:addEventListener( "postCollision", enemy1 )
		

		local enemy2 = display.newImageRect( "RubyRed.png", 30, 45 )
		--enemy2.radius = 10
		enemy2.x = 780; enemy2.y = 90
		enemy2.myName = "enemy"
		...
		physics.addBody( enemy2, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy2 )
		enemy2.gravityScale = 0

		local enemy3 = display.newImageRect( "CitrineYellow.png", 30, 45 )
		--enemy2.radius = 10
		enemy3.x = 730; enemy3.y = 200
		enemy3.myName = "enemy"
		enemy3.isBullet = true
		enemy3.isHit = false
		
		enemy3.postCollision = onEnemyPostCollision
		enemy3:addEventListener( "postCollision", enemy3 )
		
		physics.addBody( enemy3, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy3 )
		enemy3.gravityScale = 0
		
		local enemy4 = display.newImageRect( "EmeraldGreen.png", 30, 45 )
		--enemy2.radius = 10
		enemy4.x = 680; enemy4.y = 90
		enemy4.myName = "enemy"
		enemy4.isBullet = true
		enemy4.isHit = false
		
		enemy4.postCollision = onEnemyPostCollision
		enemy4:addEventListener( "postCollision", enemy4 )
		
		physics.addBody( enemy4, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy4 )
		enemy4.gravityScale = 0

		local enemy5 = display.newImageRect( "MandarineOrange.png", 30, 45 )
		--enemy2.radius = 10
		enemy5.x = 680; enemy5.y = 200
		enemy5.myName = "enemy"
		enemy5.isBullet = true
		enemy5.isHit = false
		
		enemy5.postCollision = onEnemyPostCollision
		enemy5:addEventListener( "postCollision", enemy5 )
		
		physics.addBody( enemy5, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy5 )
		enemy5.gravityScale = 0

		local enemy6 = display.newImageRect( "PrlMagenta.png", 30, 45 )
		--enemy2.radius = 10
		enemy6.x = 630; enemy6.y = 90
		enemy6.isBullet = true
		enemy6.isHit = false
		
		enemy6.postCollision = onEnemyPostCollision
		enemy6:addEventListener( "postCollision", enemy6 )
		
		physics.addBody( enemy6, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy6 )
		enemy6.gravityScale = 0

		local enemy7 = display.newImageRect( "QuartzPurple.png", 30, 45 )
		--enemy2.radius = 10
		enemy7.x = 630; enemy7.y = 200
		enemy7.myName = "enemy"
		enemy7.isBullet = true
		enemy7.isHit = false
		
		enemy7.postCollision = onEnemyPostCollision
		enemy7:addEventListener( "postCollision", enemy7 )
		
		physics.addBody( enemy7, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy7 )
		enemy7.gravityScale = 0

		local enemy8 = display.newImageRect( "PaleBlue.png", 30, 45 )
		--enemy2.radius = 10
		enemy8.x = 730; enemy8.y = 90
		enemy8.myName = "enemy"
		enemy8.isBullet = true
		enemy8.isHit = false
		
		enemy8.postCollision = onEnemyPostCollision
		enemy8:addEventListener( "postCollision", enemy8 )
		
		physics.addBody( enemy8, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy8 )
		enemy8.gravityScale = 0

		local enemy9 = display.newImageRect( "Pink.png", 30, 45 )
		--enemy2.radius = 10
		enemy9.x = 630; enemy9.y = 145
		enemy9.myName = "enemy"
		enemy9.isBullet = true
		enemy9.isHit = false
		
		enemy9.postCollision = onEnemyPostCollision
		enemy9:addEventListener( "postCollision", enemy9 )
		
		physics.addBody( enemy9, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy9 )
		enemy9.gravityScale = 0

		local enemy10 = display.newImageRect( "JewelLime.png", 30, 45 )
		--enemy2.radius = 10
		enemy10.x = 780; enemy10.y = 145
		enemy10.myName = "enemy"
		enemy10.isBullet = true
		enemy10.isHit = false
		
		enemy10.postCollision = onEnemyPostCollision
		enemy10:addEventListener( "postCollision", enemy10 )
		
		physics.addBody( enemy10, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy10 )
		enemy10.gravityScale = 0

		local enemy11 = display.newImageRect( "PrlBurgundy.png", 30, 45 )
		--enemy2.radius = 10
		enemy11.x = 730; enemy11.y = 145
		enemy11.myName = "enemy"
		enemy11.isBullet = true
		enemy11.isHit = false
		
		enemy11.postCollision = onEnemyPostCollision
		enemy11:addEventListener( "postCollision", enemy11 )
		
		physics.addBody( enemy11, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy11 )
		enemy11.gravityScale = 0

		local enemy12 = display.newImageRect( "PrlMidnightBlue.png", 30, 45 )
		--enemy2.radius = 10
		enemy12.x = 680; enemy12.y = 145
		enemy12.myName = "enemy"
		enemy12.isBullet = true
		enemy12.isHit = false
		
		enemy12.postCollision = onEnemyPostCollision
		enemy12:addEventListener( "postCollision", enemy12 )
		
		physics.addBody( enemy12, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy12 )
		enemy12.gravityScale = 0

		local enemy13 = display.newImageRect( "PrlMidnightBlue.png", 30, 45 )
		--enemy2.radius = 10
		enemy13.x = 630; enemy13.y = 35
		enemy13.myName = "enemy"
		enemy13.isBullet = true
		enemy13.isHit = false
		
		enemy13.postCollision = onEnemyPostCollision
		enemy13:addEventListener( "postCollision", enemy13 )
		
		physics.addBody( enemy13, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy13 )
		enemy13.gravityScale = 0

		local enemy14 = display.newImageRect( "Orange.png", 30, 45 )
		--enemy2.radius = 10
		enemy14.x = 680; enemy14.y = 35
		enemy14.myName = "enemy"
		enemy14.isBullet = true
		enemy14.isHit = false
		
		enemy14.postCollision = onEnemyPostCollision
		enemy14:addEventListener( "postCollision", enemy14 )
		
		physics.addBody( enemy14, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy14 )
		enemy14.gravityScale = 0

		local enemy15 = display.newImageRect( "PrlForestGreen.png", 30, 45 )
		--enemy2.radius = 10
		enemy15.x = 730; enemy15.y = 35
		enemy15.myName = "enemy"
		enemy15.isBullet = true
		enemy15.isHit = false
		
		enemy15.postCollision = onEnemyPostCollision
		enemy15:addEventListener( "postCollision", enemy15 )
		
		physics.addBody( enemy15, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy15 )
		enemy15.gravityScale = 0

		local enemy16 = display.newImageRect( "Yellow.png", 30, 45 )
		--enemy2.radius = 10
		enemy16.x = 780; enemy16.y = 35
		enemy16.myName = "enemy"
		enemy16.isBullet = true
		enemy16.isHit = false
		
		enemy16.postCollision = onEnemyPostCollision
		enemy16:addEventListener( "postCollision", enemy16 )
		
		physics.addBody( enemy16, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy16 )
		enemy16.gravityScale = 0

		local enemy17 = display.newImageRect( "DarkBlue.png", 30, 45 )
		--enemy2.radius = 10
		enemy17.x = 830; enemy17.y = 35
		enemy17.myName = "enemy"
		enemy17.isBullet = true
		enemy17.isHit = false
		
		enemy17.postCollision = onEnemyPostCollision
		enemy17:addEventListener( "postCollision", enemy17 )
		
		physics.addBody( enemy17, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy17 )
		enemy17.gravityScale = 0

		local enemy18 = display.newImageRect( "Green.png", 30, 45 )
		--enemy2.radius = 10
		enemy18.x = 830; enemy18.y = 90
		enemy18.myName = "enemy"
		enemy18.isBullet = true
		enemy18.isHit = false
		
		enemy18.postCollision = onEnemyPostCollision
		enemy18:addEventListener( "postCollision", enemy18 )
		
		physics.addBody( enemy18, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy18 )
		enemy18.gravityScale = 0

		local enemy19 = display.newImageRect( "SparklingBurgundy.png", 30, 45 )
		--enemy2.radius = 10
		enemy19.x = 830; enemy19.y = 145
		enemy19.myName = "enemy"
		enemy19.isBullet = true
		enemy19.isHit = false
		
		enemy19.postCollision = onEnemyPostCollision
		enemy19:addEventListener( "postCollision", enemy19 )
		
		physics.addBody( enemy19, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy19 )
		enemy19.gravityScale = 0

		local enemy20 = display.newImageRect( "PrlTeal.png", 30, 45 )
		--enemy2.radius = 10
		enemy20.x = 830; enemy20.y = 200
		enemy20.myName = "enemy"
		enemy20.isBullet = true
		enemy20.isHit = false
		
		enemy20.postCollision = onEnemyPostCollision
		enemy20:addEventListener( "postCollision", enemy20 )
		
		physics.addBody( enemy20, "dynamic", { density=enemyDensity, bounce=0, friction=0.0, shape=monsterShape } ) 
		levelGroup:insert( enemy20 )
		enemy20.gravityScale = 0
