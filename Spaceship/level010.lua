...
-- Score
score20 = display.newImage('score20.png', 115, 245)
    transition.from(score20, {time = 1000, alpha = 0.1, onComplete = function() timer.performWithDelay(2500, function() transition.to(score20, {time = 200, alpha = 0.1, onComplete = function() display.remove(score20) score20 = nil end}) end) end})
...
function gameOver()
   ...
   storyboard.removeScene("level010")
