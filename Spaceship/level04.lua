...
bgMusic = audio.loadStream('POL-voyager-short.mp3')
...
function scene:createScene(event)
   ...
   -- physics.addBody(spaceship, "dynamic", {density=.1, bounce=0.1, friction=.2, radius=12})
    ...
    --scoreTF:setTextColor(255, 255, 255)
     ...
     mine4 = display.newImage("alien1.png")
     mine4.x = 1250
     mine4.y = 190
     mine4.speed = math.random(8,9)
     mine4.initY = mine4.y
...
function gameOver()
   ...
   storyboard.removeScene("level04")
