...
function scene:createScene( event )
			...
			for j=1,4 do
				...
				levelIndex = levelIndex + 1
					local imagesId = levels[levelIndex] 
						...
						leveltxt = display.newText("Level "..tostring(tablePlace), 0,0, "Helvetica", 15)
						leveltxt.x = 70 + (j*65)
						leveltxt .y = 110+ (i*65)
						leveltxt:setTextColor (255, 255, 255)
	...
	local title = display.newText( "Select Level", 0, 0, "Helvetica", 25 )
	title.x = display.screenOriginX + 100
