...
function scene:createScene(event)
	...
	--local background = display.newImage("spaceBg.png")
...
-- Score
score60 = display.newImage('score60.png', 115, 245)
    transition.from(score60, {time = 1000, alpha = 0.1, onComplete = function() timer.performWithDelay(2500, function() transition.to(score60, {time = 200, alpha = 0.1, onComplete = function() display.remove(score60) score60 = nil end}) end) end})
...
function gameOver()
   ...
   storyboard.removeScene("level01")
